      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pt-16">
        <div className="max-w-4xl mx-auto text-center">
          ...
          delay: 0.2
            ...
            <span className="text-transparent bg-gradient-to-r from-white to-blue-100 bg-clip-text">Há mais de 25 anos criando soluções em áudio profissional para eventos, igrejas, teatros e espaços corporativos</span>
          </motion.h1>
          ...
          delay: 0.8
            ...
            <Button onClick={() => scrollToSection('#metodologia')} size="lg" className="bg-gradient-cta hover:shadow-cta text-white font-bold px-8 py-4 text-lg rounded-modern w-full sm:w-auto transition-all duration-300 hover:scale-105">
              <Target className="w-5 h-5 mr-2" />
              Quero Ver a Proposta Completa
            </Button>
            <Button onClick={() => scrollToSection('#investimento')} variant="outline" size="lg" className="border-2 border-white hover:bg-white hover:text-blue-professional font-semibold px-8 py-4 text-lg rounded-modern w-full sm:w-auto transition-all duration-300 text-gray-900">
