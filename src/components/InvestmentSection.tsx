...
const InvestmentSection = () => {
  ...
  return (
    <section id="investimento" className="py-16 lg:py-24 bg-white">
        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
                <div className="mb-4 md:mb-0">
                  ...
                  <div className="flex items-baseline">
                    <span className="text-4xl font-bold text-blue-professional">R$ 1.200</span>
          ...
          >
            ...
            <Button
              ...
              size="lg"
              className="bg-gradient-cta hover:shadow-cta text-white font-bold px-8 py-4 text-lg rounded-modern transition-all duration-300 hover:scale-105"
            >
